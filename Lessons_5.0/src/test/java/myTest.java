...
public class myTest{
    ...
    public void setUpBeforeClass() {
        Configuration.baseUrl = "https://culture.gosuslugi.ru/";
    }

    @Test
    public void click_login_test() {
        open("https://culture.gosuslugi.ru");
